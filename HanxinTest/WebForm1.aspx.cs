...
namespace HanxinTest
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            iWidth = HanXinHandler.HXHandler.EnCsText(szData1, iSetVersion, iRsLevel, iScale, iSpace, bb, path);

            if (iWidth > 0)
            {
                //szInfoNum = HanxinCodeHandler.DeCodeCsbyte(bb, iWidth, szInfo);

                szInfoNum = HanXinHandler.HXHandler.DeCodeCsbyte(bb, iWidth, szInfo);
